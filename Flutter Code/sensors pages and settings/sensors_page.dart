...
class _SensorDashboardState extends State<SensorDashboard> {
  ...
  void initState() {
    ...
    mqttClientWrapper.onMessageReceived =
        _onMessageReceived; //set up callback to for messsage reception and subscribe to various Topics
    ...
    return Container(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              Image.asset(imagePath, height: 60, color: textColor),
              SizedBox(width: 16),
              Expanded(
                child: Text(
                  '$title: $value',
